...
<body>
    ...
    <div id="default-carousel" class="relative w-full p-5" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96 pt-5">
            <!-- Item 1 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="/img/foto agung.jpeg"
    ...
    {{-- image 1 --}}
    <div class="grid grid-cols-1 gap-4 ml-44 mt-15 md:grid-cols-1 lg:grid-cols-2 pb-20">
        <a href="#"
