...
@section('container')
    <div class="container overflow-hidden">
        ...
        <div>
            ...
            <h1 class="flex justify-center text-5xl font-bold pb-3 pt-4 text-stone-600 md:pt-4">
                Fantastic 4
            </h1>
            <div
                ...
                <section
                    ...
                    <div class="w-[300px] h-[420px] bg-transparent cursor-pointer group perspective">
                        <div class="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
                            <div class="absolute backface-hidden border-4 w-full h-full border-orange-200">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <ul class="flex space-x-4 sm:mt-0">
                                        <li>
                                            <a href="#"
                                                class="text-stone-600 hover:text-gray-900 dark:hover:text-white">
                                        ...
                                        <li>
                                            <a href="https://www.linkedin.com/in/mochriyanputrasuryadi/"
                                                class="text-stone-600 hover:text-gray-900 dark:hover:text-white">
                                                <svg class="w-10 h-10 mt-2" fill="currentColor" viewBox="0 0 24 24"
                                                    aria-hidden="true">
                                                    <path fill-rule="evenodd"
