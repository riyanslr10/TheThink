        ...
        <div class="flex justify-center mb-3">
            <div class="md:w-1/2">
                ...
                <form action="/posts" method="GET" id="searchForm"
                    class="flex justify-center mx-auto w-full xl:w-3/4 lg:w-11/12 my-10 rounded-s-xl p-2">
            ...
            <div class="container">
                <div class="grid grid-cols-3 gap-9 mx-10">
                    @foreach ($posts->skip(0) as $post)
                        <div class="card w-full h-full   md:w-full lg:w-full xl:w-full bg-orange-100 border-4 border-orange-200 rounded-lg shadow hover:bg-orange-200 hover:border-orange-300 mb-4 overflow-hidden"
