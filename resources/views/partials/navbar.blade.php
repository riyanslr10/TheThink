<nav class=" shadow-lg relative z-40">
    <div class="bg-white fixed w-full flex flex-wrap items-center justify-between py-1 text-center shadow-xl">
        ...
        <div class="flex md:order-2 pl-24 pr-5">
            ...
            <div class="items-center space-x-3 md:order-1 md:space-x-0 rtl:space-x-reverse px-5 hidden md:block">
                <ul class="flex items-center space-x-4 font-bold">
                    @auth
                        <li class="relative group">
                            ...
                            <div class="hidden absolute right-0 mt-2 space-y-2 bg-sttext-stone-600 text-lg font-bold border border-gray-200 rounded-md shadow-md"
