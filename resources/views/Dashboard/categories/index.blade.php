...
<div class="p-4 sm:ml-64">
    ...
    <div class="col-lg-6">
        <a href="/dashboard/categories/create" class="bg-blue-500 hover:bg-blue-700 text-stone-900 font-bold px-4 py-2 rounded-lg mb-3 inline-block">Create new category</a>
       
        <table class="w-full text-lg text-left rtl:text-right text-gray-500 dark:text-gray-400 border-8 border-gray-700 ">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border-b border-gray-200 px-4 py-4">
                            <div class="flex flex-col items-start">
                                <a href="/dashboard/categories/{{ $category->slug }}/edit" class="bg-yellow-400 text-white px-2 py-1 rounded-lg mb-2">
