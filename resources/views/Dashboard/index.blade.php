...
<div class="p-4 sm:ml-64">
    <div class="p-4 bg-slate-600 border-gray-800 border-8 rounded-lg dark:border-gray-700 mt-14">
...
<div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800">
   <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
    ...
    <p class="text-2xl font-extrabold text-gray-800 dark:text-gray-500 ml-4">
       <a href="/dashboard/posts"> {{ auth()->user()->name }} memiliki {{ auth()->user()->posts->count() }} Posts Books</a>
    </p>
