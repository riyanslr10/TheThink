...
<nav class="fixed top-0 z-50 w-full bg-white border-b-8 border-gray-400 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex items-center justify-between">
          <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="/dashboard" class="flex ms-2 md:me-24">
              <img src="/img/Fantastic 4.jpeg" class="w8 h-8 me-3" alt="FlowBite Logo" />
              <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-stone-900">TheThink</span>
            </a>
          </div>  
