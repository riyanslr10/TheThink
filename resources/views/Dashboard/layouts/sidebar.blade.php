...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-45 h-screen pt-20 transition-transform -translate-x-full bg-white border-r-8 border-orange-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    aria-label="Sidebar">
        ...
        <ul class=" font-medium mt-2">
            ...
            <li class="border-b-orange-200 border-b-2">
                <a href="/dashboard/posts"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-lg font-bold">Books</span>
                </a>
            </li>

            @can('admin')
                <h6 class="flex items-center p-6  dark:text-white group border-b-orange-200 border-b-2"">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-800 transition duration-75 dark:text-gray-400"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                        <path
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-lg font-bold">Administrator</span>
                </h6>
                <li class="border-b-orange-200 border-b-2">
                    <a href="/dashboard/categories"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-lg font-bold">Categories</span>
                    </a>
                </li>
            @endcan
        </ul>
