...
@endif
        ...
        <div class="mt-5 mb-5">
            ...
            <a href="/dashboard/posts/create"
                class="bg-green-400 border-8 border-green-400 hover:bg-green-600 hover:border-green-600 text-lg rounded-md divide-y-4 font-bold ">Create
                New Post</a>


            <div class="relative overflow-x-auto border-8 border-orange-300 shadow-md sm:rounded-lg mt-6">
                <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-orange-200 dark:bg-gray-700 dark:text-gray-400">
                        <tr
                            class="bg-orange-200 border-b-8 border-b-orange-300 dark:bg-gray-800 dark:border-gray-700 text-center">
                            <th scope="row" class="py-4 text-gray-900 text-sm whitespace-nowrap dark:text-white">No</th>
                            <th scope="row" class="px-4 py-4 text-gray-900 text-sm whitespace-nowrap dark:text-white">
                                Title</th>
                            <th scope="row" class="px-4 py-4 text-gray-900 text-sm whitespace-nowrap dark:text-white">
                                Category</th>
                            <th scope="row" class="px-4 py-4 text-gray-900 text-sm whitespace-nowrap dark:text-white">
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr
                                class="bg-orange-100 border-b-8 border-b-orange-300 dark:bg-gray-800 dark:border-gray-700 text-stone-600 font-bold text-lg">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col items-start">
                                        <a href="/dashboard/posts/{{ $post->slug }}"
                                            class="bg-green-500 text-white px-2 py-1 rounded-lg mb-2">
